...
int AnaModule::process_event(PHCompositeNode* topNode)
{
  ...
  run_ID_temp = run_ID;	
	...
	std::shared_ptr<SQHitVector> hv_h1t(UtilSQHit::FindHits(event, hitVector, "H1T"));
 	std::cout << "Hits in H1T = " << hv_h1t->size() << std::endl;
	std::shared_ptr<SQHitVector> hv_h1b(UtilSQHit::FindHits(event, hitVector, "H1B"));
 	std::cout << "Hits in H1B = " << hv_h1b->size() << std::endl;
	std::shared_ptr<SQHitVector> hv_h1l(UtilSQHit::FindHits(event, hitVector, "H1L"));
 	std::cout << "Hits in H1L = " << hv_h1l->size() << std::endl;
	std::shared_ptr<SQHitVector> hv_h1r(UtilSQHit::FindHits(event, hitVector, "H1R"));
 	std::cout << "Hits in H1R = " << hv_h1r->size() << std::endl;

	//Number of Hist in : St2
	std::shared_ptr<SQHitVector> hv_h2t(UtilSQHit::FindHits(event, hitVector, "H2T"));
 	std::cout << "Hits in H2T = " << hv_h2t->size() << std::endl;
	std::shared_ptr<SQHitVector> hv_h2b(UtilSQHit::FindHits(event, hitVector, "H2B"));
 	std::cout << "Hits in H2B = " << hv_h2b->size() << std::endl;
	std::shared_ptr<SQHitVector> hv_h2l(UtilSQHit::FindHits(event, hitVector, "H2L"));
 	std::cout << "Hits in H2L = " << hv_h2l->size() << std::endl;
	std::shared_ptr<SQHitVector> hv_h2r(UtilSQHit::FindHits(event, hitVector, "H2R"));
 	std::cout << "Hits in H2R = " << hv_h2r->size() << std::endl;

	//Number of Hist in : St3
	std::shared_ptr<SQHitVector> hv_h3t(UtilSQHit::FindHits(event, hitVector, "H3T"));
 	std::cout << "Hits in H3T = " << hv_h2t->size() << std::endl;
	std::shared_ptr<SQHitVector> hv_h3b(UtilSQHit::FindHits(event, hitVector, "H3B"));
